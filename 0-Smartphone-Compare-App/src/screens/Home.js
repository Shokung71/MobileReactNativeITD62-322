    ...
    return (
        <View style={styles.header}>
            ...
            <View style={styles.titleContainer}>
                <Text style={styles.headerTitle}>เลือกมือถือ</Text>
            </View>

            {/* User Profile Section - Right */}
            <TouchableOpacity style={styles.profileContainer}>
                {user?.img_profile_base64 ? (
                    // แสดงรูปจาก base64 ในฐานข้อมูล
                    <Image
...
export default function HomeScreen({ navigation }) {
    ...
    // TODO: Get user data from your authentication/state management
    const [user, setUser] = useState(null); // or useState({ name: 'John', profileImage: null })
